  ...
  return (
    <div id='about' className='about'>
      <div className='about-title'>
        <h1>About me </h1>
        <p className='about-para'>I'm <span>MCA</span> graduate passionate about building modern, scalable digital experiences. I have hands-on experience in full-stack development, AI-powered applications, and cloud-ready web technologies.<br /> With strong fundamentals in <span>java and JavaScript</span>, and practical expertise in the <span>MERN stack and Next.js</span>, I enjoy solving complex problems and turning ideas into functional products.
